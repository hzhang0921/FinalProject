...
@app.route('/')
def index():
    ''' Render a template to the home or index page. Give the user an option to enter summoner name and tagline '''
...
def matchpage():
    ''' Render a template displaying a list of the last five matches. Give the user an option to choose which of the last five matches
    in their history that they would like to analyze. A button is placed that allows a user to return to the home/index page.'''
...
@app.route('/error')
def error():
    '''Render an error page that includes a button return to the index/home page'''
...
def match1():
    '''Return a page that displays a list of players from the game chosen. Give the user an option to choose which player's stats they want to analyze.
    Give the user an option to return to the home/index page with a button.'''
...
def matchstats():
    ''' Return the stats of player from the given game and given player. A button is presented that takes the user back to the home/index page.'''
    # obtain data
    form_data = request.form
    ...
    TotalDamagetoChampions = get_player_TotalDamagetoChampions(
